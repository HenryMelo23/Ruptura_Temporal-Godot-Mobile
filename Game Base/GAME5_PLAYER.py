        ...
        while running:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.QUIT:
                    ...
                    pygame.event.set_grab(True)
                    pygame.mouse.set_visible(False)
                elif Variaveis.verificar_evento_input(event, "Habilidade Onda") and tempo_atual - tempo_ultimo_uso_habilidade >= cooldown_habilidade * lacerante_manifestacao.multiplicador_cooldown_habilidade(manifestacao_ativa) and tempo_atual >= tempo_fim_stun:
                    pos_mouse = obter_pos_mouse_jogo()
