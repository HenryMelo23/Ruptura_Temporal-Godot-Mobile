...
def tela_selecao_aurea(tela, fonte):
    ...
    aureas = [
        ...
        },
        {
            ...
            "efeito": "Escolhe uma das dez Ã¡ureas ativas ao iniciar a jornada, mudando a estratÃ©gia da partida.",
            "atributos": [
                "â€¢ Pode vir Racional, Impulsiva, Devota, Vanguarda, Insana, Voraz, Nula, Abissal, Profetica ou Sanguinaria.",
    ...
    for nova_aurea in [
        ("Nula", "Sprites/aurea_nula.png", (220, 240, 255), (15, 24, 34)),
        ("Abissal", "Sprites/aurea_abissal.png", (60, 160, 255), (8, 18, 38)),
        ("Profetica", "Sprites/aurea_profetica.png", (255, 220, 80), (38, 30, 8)),
        ("Sanguinaria", "Sprites/aurea_sanguinaria.png", (255, 70, 95), (42, 8, 16)),
    ]:
        aureas.insert(-1, {
            "nome": nova_aurea[0],
            "imagem": nova_aurea[1],
            "ativa": True,
            "cor_tema": nova_aurea[2],
            "bg_tema": nova_aurea[3],
            "categoria": "",
            "efeito": "",
            "atributos": [],
            "lore": "",
...
def tela_configuracoes_jogabilidade(tela, fonte):
    ...
    descricoes_valores = {
        ...
        "loja_forcada": {
            True: "Abre um aviso de 15s quando ha pontos para comprar 10 cartas.",
            False: "Nunca forca a loja por acumulo de pontos."
        }
    }
...
def _dados_catalogo_temporal():
    ...
    return {
        ...
        "Aureas": [
            ...
            {"nome": "Aurea Nula", "imagem": "Sprites/aurea_nula.png", "funcionamento": "Vazio e anulacao. A barra Vazio carrega com o tempo. Ao completar 100%, o proximo auto attack vira Tiro Nulo, causando dano bonus e deixando o alvo vulneravel por uma janela curta.", "historia": "Onde o tempo falha, o vazio aprende a responder."},
            {"nome": "Aurea Abissal", "imagem": "Sprites/aurea_abissal.png", "funcionamento": "Pressao de area. Inimigos proximos sofrem erosao leve, ficam expostos e alimentam Colapso. Ao completar a barra, Colapso pulsa em area e causa dano aos alvos ao redor.", "historia": "O abismo nao corre. Ele espera tudo cair."},
            {"nome": "Aurea Profetica", "imagem": "Sprites/aurea_profetica.png", "funcionamento": "Pressagio. A aura marca periodicamente um inimigo proximo. Acertar o alvo marcado consome a marca, causa dano bonus e acelera a proxima previsao.", "historia": "Prever nao e saber o fim. E escolher onde o golpe deve cair."},
            {"nome": "Aurea Sanguinaria", "imagem": "Sprites/aurea_sanguinaria.png", "funcionamento": "Feridas e Sede. Hits repetidos no mesmo alvo abrem Ferida, aumentando dano recebido e enchendo Sede. Com Sede cheia, Carnificina melhora dano contra feridos por poucos segundos.", "historia": "Algumas rupturas nao cicatrizam. Elas chamam o proximo golpe."},
            {"nome": "Aurea Aleatoria", "imagem": "Sprites/aurea_misteriosa.png", "funcionamento": "Seleciona uma das dez aureas ativas ao confirmar a jornada: Racional, Impulsiva, Devota, Vanguarda, Insana, Voraz, Nula, Abissal, Profetica ou Sanguinaria.", "historia": "O destino e incerto, e o tempo se desdobra in infinitas possibilidades."},
        ],
        "Fragmentos": [
