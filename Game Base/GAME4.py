...
def aplicar_hit_jogador(dano_bruto, respeitar_resistencia=True, ativar_vanguarda=True):
    ...
    if dano_final > 0:
        vida -= dano_final
        Variaveis.registrar_dano_recebido_player(efeitos_texto, dano_final, pos_x_personagem + largura_personagem // 2, pos_y_personagem - 22, agora_ms)
        ...
        while running:
            ...
            for morto_novas in mortos_novas:
                if morto_novas in inimigos_comum:
                    gerar_fragmentos_morte(morto_novas, 4)
            ...
            boss_info = {
                ...
                "vida_maxima": vida_maxima_boss4,
                "estado_laceracao": globals().setdefault("boss4_laceracao_estado", {}),
                "atingido_por_onda": globals().get("boss_atingido_por_onda", {}).get("boss", 0),
                "hit_flag": False
            }
            if boss_info["vivo"] and boss_info["rect"] is not None:
                vida_boss4, _ = lacerante_manifestacao.atualizar_laceracao_boss(
                    boss_info["estado_laceracao"], tempo_atual, vida_boss4, vida_maxima_boss4,
                    efeitos_texto, pos_x_boss4 + chefe_largura4 // 2, pos_y_boss4 - 44
                )
                    ...
                    if acertou_boss_disparo:
                        if disparo.get("tipo_manifestacao") == "lacerante_corte":
                            lacerante_manifestacao.aplicar_laceracao_boss(
                                globals().setdefault("boss4_laceracao_estado", {}),
                                tempo_atual,
                                vida_maxima_boss4,
                            )
                        ...
                        dano = novas_aureas.aplicar_dano_boss(
                            ...
                            efeitos_texto, (pos_x_boss4 + chefe_largura4 // 2, pos_y_boss4 - 32)
                        )
